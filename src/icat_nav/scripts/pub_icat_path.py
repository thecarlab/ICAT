...
# parser.add_argument('--edgepath', type=str, default=package_path+ '/data/carto_icat_edges.json', help='edge list path')
# parser.add_argument('--nodepath', type=str, default=package_path+ '/data/carto_icat_nodes.json', help='node list path')

parser.add_argument('--edgepath', type=str, default= 'icat_edges.json', help='edge list path')
parser.add_argument('--nodepath', type=str, default= 'icat_nodes.json', help='node list path')
...
#         self.pub = rospy.Publisher('/icat_path', Path, queue_size=10)
