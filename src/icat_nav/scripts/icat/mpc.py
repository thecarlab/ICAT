...
class MPC:
    def __init__(self):
        ...
        self.traj_path_sub = rospy.Subscriber("traj_path", Path, self.traj_path_callback)
        self.car_state_sub = rospy.Subscriber("car_state", Twist, self.car_state_callback)
        self.vel_raw_sub = rospy.Subscriber("vel_raw", Twist, self.vel_raw_callback)
    ...
    def QP_method(self):
        ...
        # Dynamic bounds
        vmax = 0.3 # Maximum linear velocity
        vmin = 0.2
